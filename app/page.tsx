...
export default function HomePage() {
  ...
  const testimonials = [
    ...
    },
    {
      name: "Peter Horváth",
      rating: 5,
      text: "Najlepšie ceny v meste a kvalitné služby. Chodím sem už roky.",
    },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              ...
              <span className="block text-orange-400">rýchlo a spoľahlivo</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              Profesionálne služby STK a EK s 15-ročnými skúsenosťami. 
              Rezervujte si termín online a ušetrite čas.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link 
                href="/rezervacia"
                className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors inline-flex items-center justify-center group"
              >
                Rezervovať termín
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-gray-600">úspešných kontrol</div>
            </div>
            <div className="flex flex-col items-center">
              ...
              <div className="text-gray-600">priemerný čas</div>
            </div>
            <div className="flex flex-col items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-8 border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Technická kontrola (STK)</h3>
            ...
            <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-8 border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Emisná kontrola (EK)</h3>
              <p className="text-gray-600 mb-6">
            ...
            <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-8 border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Opakovaná kontrola</h3>
              <p className="text-gray-600 mb-6">
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Pripravený na technickou kontrolu?
          </h2>
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Rezervujte si termín online a ušetrite čas. Naši experti sa postarajú o váš vozidlo.
          </p>
          <Link 
            href="/rezervacia"
            className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors inline-flex items-center group"
          >
            Rezervovať termín
            <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
          </Link>
